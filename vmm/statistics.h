...
#define STATISTICS_ID_VMMDLL_ProcessGetMemoryMap                0x12
#define STATISTICS_ID_VMMDLL_ProcessGetMemoryMapEntry           0x13
#define STATISTICS_ID_VMMDLL_ProcessGetModuleMap                0x14
#define STATISTICS_ID_VMMDLL_ProcessGetModuleFromName           0x15
#define STATISTICS_ID_VMMDLL_ProcessGetDirectories              0x16
#define STATISTICS_ID_VMMDLL_ProcessGetSections                 0x17
#define STATISTICS_ID_VMMDLL_ProcessGetEAT                      0x18
#define STATISTICS_ID_VMMDLL_ProcessGetIAT                      0x19
#define STATISTICS_ID_VMMDLL_ProcessGetProcAddress              0x1a
#define STATISTICS_ID_VMMDLL_ProcessGetModuleBase               0x1b
#define STATISTICS_ID_VMMDLL_WinGetThunkEAT                     0x1c
#define STATISTICS_ID_VMMDLL_WinGetThunkIAT                     0x1d
#define STATISTICS_ID_VMMDLL_WinMemCompression_DecompressPage   0x1e
#define STATISTICS_ID_VMMDLL_WinRegHive_List                    0x1f
#define STATISTICS_ID_VMMDLL_WinRegHive_ReadEx                  0x20
#define STATISTICS_ID_VMMDLL_WinRegHive_Write                   0x21
#define STATISTICS_ID_VMMDLL_WinReg_EnumKeyExW                  0x22
#define STATISTICS_ID_VMMDLL_WinReg_EnumValueW                  0x23
#define STATISTICS_ID_VMMDLL_WinReg_QueryValueExW               0x24
#define STATISTICS_ID_VMMDLL_WinNet_Get                         0x25
#define STATISTICS_ID_VMMDLL_Refresh                            0x26
#define STATISTICS_ID_VMMDLL_UtilFillHexAscii                   0x27
#define STATISTICS_ID_VMMDLL_PdbSymbolAddress                   0x28
#define STATISTICS_ID_VMMDLL_PdbTypeSize                        0x29
#define STATISTICS_ID_VMMDLL_PdbTypeChildOffset                 0x2a
#define STATISTICS_ID_VMM_PagedCompressedMemory                 0x2b
#define STATISTICS_ID_MAX                                       0x2b
