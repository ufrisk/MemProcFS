...
NTSTATUS MStatus_Read(_In_ PVMMDLL_PLUGIN_CONTEXT ctx, _Out_writes_to_(cb, *pcbRead) PBYTE pb, _In_ DWORD cb, _Out_ PDWORD pcbRead, _In_ QWORD cbOffset)
{
    ...
    if(!_wcsicmp(ctx->wszPath, L"statistics_fncall.txt")) {
...
BOOL MStatus_List(_In_ PVMMDLL_PLUGIN_CONTEXT ctx, _Inout_ PHANDLE pFileList)
{
    ...
    if(!ctx->pProcess) {
        ...
        VMMDLL_VfsList_AddFile(pFileList, L"config_fileinfoheader_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_cache_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_paging_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_statistics_fncall.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_tick_period_ms.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_read.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_tlb.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_proc_partial.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_proc_total.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_refresh_registry.txt", 8, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_symbol_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_symbolcache.txt", strlen(ctxMain->pdb.szLocal), NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_symbolserver.txt", strlen(ctxMain->pdb.szServer), NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_symbolserver_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"statistics.txt", 1103, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_printf_enable.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_printf_v.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_printf_vv.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_printf_vvv.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"config_process_show_terminated.txt", 1, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"native_max_address.txt", 16, NULL);
        VMMDLL_VfsList_AddFile(pFileList, L"statistics_fncall.txt", cbCallStatistics, NULL);
    }
    return TRUE;
}
